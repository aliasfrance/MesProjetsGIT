...
public class ClientRepositoryImpl implements ClientRepository {
	...
	@Autowired
	private static int idxClient = 1;// Compteur pour générer les IDs des clients
	...
	public List<Client> getAll() {
		String sql = "select * from client"; // SQL pour récupérer tous les clients

		List<Client> clients = jdbcTemplate.query(sql, new ClientRowMapper());// Exécuter la requête et mapper les résultats
